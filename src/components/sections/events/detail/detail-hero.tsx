    ...
    <section className="pb-8 pt-40 sm:pt-48">
      <div className="container-content">
        ...
        <div className="glass mt-9 grid grid-cols-2 gap-6 rounded-2xl p-6 sm:grid-cols-4 sm:p-8">
          <MetaItem icon={Calendar} label="DATE" value={formatDateRange(event.startDate, event.endDate)} />
          ...
          <div className="mt-8 flex flex-wrap items-center gap-6">
            <div className="flex gap-3">
              {countdownUnits.map((unit) => (
                <div key={unit.key} className="glass rounded-xl px-4 py-3 text-center">
